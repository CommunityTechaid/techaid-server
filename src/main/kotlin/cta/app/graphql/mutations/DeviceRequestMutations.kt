        ...
        try {
            ...
            try {
                ...
                throw IllegalArgumentException(
                    "Invalid date format: $dateString. Expected ISO 8601 format (e.g., '2025-12-05T19:16:00Z', '2025-12-05T19:16:00+01:00', or '2025-12-05T19:16')",
                )
            }
        }
    }
...
class DeviceRequestMutations(
    ...
    fun createDeviceRequest(
        @Argument @Valid data: CreateDeviceRequestInput,
    ): DeviceRequest {
    ...
    private fun generateCorrelationId(): Long = kotlin.random.Random.nextLong(1, Long.MAX_VALUE)

    @PreAuthorize("hasAnyAuthority('write:organisations')")
    @MutationMapping
    fun updateDeviceRequest(
        @Argument @Valid data: UpdateDeviceRequestInput,
    ): DeviceRequest {
        val entity =
            deviceRequests.findById(data.id).toNullable()
        ...
        return data.apply(entity).apply {
            ...
            if (data.deviceRequestNote != null) {
                if (data.deviceRequestNote.content !== "") {
                    ...
                    val deviceRequestNote =
                        DeviceRequestNote(content = data.deviceRequestNote.content, deviceRequest = this, volunteer = volunteer)
